...
namespace Shayer\EduEssayPlugin\UI\WidgetRepeaterInput;
...
class WidgetRepeaterInputProvider implements ActionHookSubscriberInterface
{
	/**
	...
	public function render(): void
	{
		...
		require dirname(__DIR__) . '/WidgetRepeaterInput/WidgetRepeaterInputView.php';
	}
}
