...
namespace Shayer\EduEssayPlugin\UI\WidgetRepeaterProductCategory;
...
class WidgetRepeaterProductCatProvider implements ActionHookSubscriberInterface
{
	/**
	...
	{
		return [
			'essay_page_product_category_content' => ['render'],
		];
	}
	...
	public function render(): void
	{
		...
		require dirname(__DIR__) . '/WidgetRepeaterProductCategory/WidgetRepeaterProductCatView.php';
	}
}
