...
class MinPricePageService implements GetValueServiceInterface
{
    const OPTION_SLUG = 'essay_calc_min_price_page';
    ...
    public function updateValue(array $value): bool
    {
        ...
        if (!$result) {
            throw new Exception('Invalid process append min price for page');
        }
